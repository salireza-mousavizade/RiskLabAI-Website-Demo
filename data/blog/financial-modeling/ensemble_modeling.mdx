...
<div className="my-1 overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2" style={{display: 'block', marginLeft: 'auto', marginRight: 'auto', width: '90%', alignItems: 'center', justifyContent: 'center'}}>
    ![Standard Deviation of the bagged prediction](/static/Figs/financial-modeling/StandardDeviationofthebaggedprediction.png)
</div>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
    <table style={{padding:0,margin:0, tableLayout: 'fixed', width: '100%'}}>
        <tr>
            <th style={{width: '50%', textAlign: 'center', color: 'darkgoldenrod', fontFamily:'sans-serif', fontSize: '1.25rem',}}>Python</th>
            <th style={{width: '50%', textAlign: 'center', color: 'rebeccapurple', fontFamily:'sans-serif', fontSize: '1.25rem', }}>Julia</th>
        </tr>
        <tr>

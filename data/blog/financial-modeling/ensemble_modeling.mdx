...
<div style={{display: 'flex', justifyContent: 'center'}}>
    <table style={{padding:0,margin:0, tableLayout: 'fixed', width: '100%'}}>
        <tr>
            <th style={{width: '50%', textAlign: 'center', color: 'darkgoldenrod', fontFamily:'sans-serif', fontSize: 2,}}>Python</th>
            <th style={{width: '50%', textAlign: 'center', color: 'rebeccapurple', fontFamily:'sans-serif', fontSize: 2, }}>Julia</th>
        </tr>
        <tr>
